...
.players-panel{grid-column:1;grid-row:1}.action-panel{grid-column:1;grid-row:2}.inspect-panel{grid-column:2;grid-row:1/3}.action-grid{grid-template-columns:repeat(2,1fr)}`;
